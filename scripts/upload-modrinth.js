...
(async () => {
    ...
    for (let version of versions){
        console.log(await execSync(`ezpack export modrinth ${version}`, {cwd: path.dirname(__dirname)}))
        console.log(await execSync(`ezpack export modsZip ${version}`, {cwd: path.dirname(__dirname)}))
